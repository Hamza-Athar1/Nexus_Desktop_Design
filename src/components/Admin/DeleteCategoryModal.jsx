...
/**
 * DeleteCategoryModal - Confirmation modal for deleting a main category.
 * Matches Screenshot 5 in the design spec.
 */
export default function DeleteCategoryModal({ isOpen, onClose, category, onDelete }) {
        ...
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <p className="text-xs font-semibold text-[#0c3818]/80 leading-relaxed">
              Are you sure you want to delete <span className="font-extrabold text-[#0c3818]">"{category.name}"</span>? This action will permanently remove this category. All associated items will be unassigned.
            </p>
          </div>
        </div>
