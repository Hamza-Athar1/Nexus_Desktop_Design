...
export default function AddPOSModal({ isOpen, onCancel, onSave }) {
  const [name, setName] = useState('');
  const [price, setPrice] = useState('');
  const [theme, setTheme] = useState(PRESETS_THEMES[1]); // Default to Forest palette
            ...
            <div className="lg:col-span-5 flex flex-col gap-3">
              ...
              >
                ...
                <button
                  ...
                  onClick={() => alert(`Reviewing ${name || 'new POS'} action button!`)}
                >
                  Sample button
                </button>
              </div>
